...
<div class="header">
	<div class="mainHeader">
  		<nav>
			...
			<a href="banking.html" class="active">View All Customers</a>
			<a href="sending.html" class="active">Money Transaction</a>
		</nav>
		<div class="menubtn">
...
<body>
    <div class="my-info text-center">
        <h2>Details </h2>
        <h4>Bank Balance<span id="myAccountBalance">1000000</span></h4>

        <button class="btn btn-info my-3" data-toggle="modal" data-target="#sendMoney">Send Money</button>
        <a class="btn btn-info my-3" href="/bankingwebd/sending.php" data-toggle="modal" data-target="#transactionHistory">See All Transaction</a>
    </div>
            ...
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                    <tr class="table-light">
                        ...
                        <td>
                            <p id=" pradipBankBalance">190000</p>
                        </td>
                    </tr>
                     <tr class="table-info">
                        <td scope="row">2</td>
                        ...
                        <td>
                            <p id="ankushBankBalance">170000</p>
                        </td>
                    </tr>
                    <tr class="table-light">
                        <td scope="row">3</td>
                        ...
                        <td>
                            <p id="rohanBankBalance">125000</p>
                        </td>
                    </tr>
                    <tr class="table-info">
                        <td scope="row">4</td>
                    ...
                    <tr class="table-light">
                        ...
                        <td>
                            <p id="SimranBankBalance">909000</p>
                        </td>
                    </tr>
                    <tr class="table-info">
                        <td scope="row">6</td>
                    ...
                    <tr class="table-info">
                        ...
                        <td>
                            <p id="AnjaliBankBalance">100630</p>
                        </td>
                    </tr>
                    <tr class="table-light">
                        <td>9</td>
                        <td>Swegar</td>
                        <td>swegar@gmail.com</td>
                        <td>
                            <p id="swegarBankBalance">190000</p>
                        </td>
                        </tr>
                        <tr class="table-info">
                            <td>10</td>
                            ...
                            <td>
                                <p id="rakeshBankBalance">290000</p>
                            </td>
                        </tr>
